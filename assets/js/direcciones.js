...
function getAddressOnList() {
    ...
    let addressObj = {
        ...
        lunes           : tipoContacto != 1 ? $("#lunesFormCliente").prop("checked") : null,
        martes          : tipoContacto != 1 ? $("#martesFormCliente").prop("checked") : null,
        miercoles       : tipoContacto != 1 ? $("#miercolesFormCliente").prop("checked") : null,
        jueves          : tipoContacto != 1 ? $("#juevesFormCliente").prop("checked") : null,
        viernes         : tipoContacto != 1 ? $("#viernesFormCliente").prop("checked") : null,
        sabado          : tipoContacto != 1 ? $("#sabadoFormCliente").prop("checked") : null,
        domingo         : tipoContacto != 1 ? $("#domingoFormCliente").prop("checked") : null,
